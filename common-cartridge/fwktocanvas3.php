...
$folder = "genchem";
//this is where we're going to be uploading extracted images
//this script doesn't embed the images in the cartridge, but instead assumes
//we're going to host them elsewhere.
$webroot = 'https://textimgs.s3.amazonaws.com/genchem/';
...
<ul>
<li><a href="'.$webroot.'index.html">Content</a> created by Anonymous under a <a href="http://creativecommons.org/licenses/by-nc-sa/3.0" rel="license">Creative Commons Attribution Non-Commercial Share-Alike License</a></li>
