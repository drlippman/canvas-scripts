...
$webroot = 'https://textimgs.s3.amazonaws.com/soc/';
...
function fileize($str,$i,$j,$title) {
	global $webroot;
	$attr = '<hr />
<div style="font-size: x-small;">This page is licensed under a <a href="http://creativecommons.org/licenses/by/3.0" rel="license">Creative Commons Attribution License</a> and contains content from a variety of sources published under a variety of open licenses, including:
<ul>
<li>Content created by OpenStax College for Rice University under a <a href="http://creativecommons.org/licenses/by/3.0" rel="license">Creative Commons Attribution License</a>. Download for free at <a href="http://cnx.org/content/col11407/latest/">http://cnx.org/content/col11407/latest/</a>.</li>
...
<p>If you believe that a portion of this Open Course Framework infringes another\'s copyright, <a href="http://lumenlearning.com/copyright">contact us</a>.</p>
	...
	$str = preg_replace('/<a[^]*href="c.\d+.html[^>]*>(.*?)</a>/','$1',$str);
	...
	$str = preg_replace('/<span[^>]*>/sm','<span>',$str);
...
copy("./canvasbase.zip",'./'.$folder.'.zip');
$zip = new ZipArchive;
...
/*
Don't need this - linking out to all images
